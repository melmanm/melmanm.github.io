---
layout: post
title: "Yet another way of implementing modal dialogs in WPF MVVM"
categories: misc
tags:
- dotnet
- WPF
...
![spotify-dialog](/assets/img/article16/cover-image.png)
...
## Motivation
Over time, I've seen multiple implementations and ideas on how to deal with modal dialogs in WPF applications. 
