...
- [Polling Based Solutions](#polling-based-solutions)
  - [Solution 1 - check_session_iframe endpoint](#solution-1---check_session_iframe-endpoint)
  - [Solution 2 - /authorize endpoint polling](#solution-2---authorize-endpoint-polling)
- [Logout Based Solutions](#logout-based-solutions)
  - [Solution 3 - Front-Channel Logout](#solution-3---front-channel-logout)
  - [Solution 4 - Back-Channel Logout](#solution-4---back-channel-logout)
